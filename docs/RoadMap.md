...
- [ ] AI Skills, context and setup so everyone's claude is in sync with the way of developing shit. Add direct wiring to MCP's with RN, Android, Firebase and iOS docs.
