...
with tab3:
    ...
    - **911**: Número general para emergencias (policía, ambulancia, bomberos).  
      ¡Disponible en todo el país para situaciones urgentes!
    - **065**: Cruz Roja.  
      Para asistencia médica de emergencia.
    - **089**: Denuncia anónima.  
      Úsalo para reportar actividades sospechosas o delictivas.
    - **800 822 87 22**: Protección Civil.  
      Para reportar riesgos o solicitar ayuda en desastres naturales.
    - **074**: Auxilio vial en carreteras.  
      Ideal si necesitas asistencia mientras viajas.
    ...
    st.markdown("""
    **⬇️ Descarga esta lista en PDF:**  
    [Haga clic aquí](#) para descargar la lista completa de números de emergencia en México.
    """, unsafe_allow_html=True)

    # Agregar una imagen representativa
    st.image("https://via.placeholder.com/700x250?text=Números+de+Emergencia", caption="Mantente preparado para cualquier emergencia.", use_column_width=True)
